	...
	\frame{\sectionpage}	
		...
		\begin{frame}{kMeans Algortihmus}
			\begin{itemize}
				...
				\item Wiederholen von Schritt 2 und 3 bis Abbruchbedingung erreicht
		...
		\begin{frame}{Silhouettenkoeffizient}
			\begin{itemize}
				...
				\item Berechnet für jede Zeile wie gut das ausgewählte Cluster passt
...
\includegraphics[scale=0.45]{../pictures/cluster.png}
	...
	\begin{center}					
					\begin{figure}[h]
						\includegraphics[scale=0.6]{../pictures/plotly_dense.png}
						\caption{Clusterung DBSCAN}		
					\end{figure}	
				\end{center}	
	\end{frame}
	\begin{frame}
